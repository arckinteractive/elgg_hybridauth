...
$plugin->setSetting('import_mapping', serialize(get_input('import_mapping', array())));
$plugin->setSetting('import_mapping_access_id', get_input('import_mapping_access_id', ACCESS_PRIVATE));
