...
$english = array(
	...
	'hybridauth:error:default' => "Error",
	...
	'elgg_hybridauth:provider:uid:reset' => "Reset User Auth",
	'elgg_hybridauth:provider:uid:reset:confirm' => "This will force all users to re-authenticate with this provider.  Are you sure?",
	'elgg_hybridauth:error:invalid:provider' => "Invalid Provider",
